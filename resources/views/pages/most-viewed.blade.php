    ...
    <div class="container content">
        <div class="row">
          <div class="large-8 medium-centered columns">
              ...
              <!-- mostViewed and highestRanked returns error "no_result_found" if it's empty (API) -->
              @if (!isset($mostViewed->error) && !isset($highestRanked->error))
              ...
              @else
                <p class="noCallouts">No callouts created.</p>
              @endif
          </div>
      </div>
        </div>
