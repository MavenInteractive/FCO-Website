            ...
            <div class="about">
                ...
                <div class="row">
                    <div class="large-6 medium-centered columns">
                        ...
                        <div class="small-6 columns profile-info-detail">
                            {{$profile->username}}
                        </div>

                        <div class="small-6 columns profile-info-label">First Name:</div>
                        <div class="small-6 columns profile-info-detail">
                            <?php if(isset($profile->first_name) && $profile->first_name != NULL): ?>
                                {{$profile->first_name}}
                            <?php else: ?>
                                &nbsp;
                            <?php endif; ?>
                        ...
                        <div class="small-6 columns profile-info-detail">
                            <?php if(isset($profile->last_name) && $profile->last_name != NULL): ?>
                                {{$profile->last_name}}
                            <?php else: ?>
                                &nbsp;
                            <?php endif; ?>
                        ...
                        <div class="small-6 columns profile-info-detail">
                            <?php if(isset($country->description) && $country->description != NULL): ?>
                                {{$country->description}}
                            <?php else: ?>
                                &nbsp;
                            <?php endif; ?>
